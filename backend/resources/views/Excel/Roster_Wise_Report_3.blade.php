...
<table class="blueTable">
    ...
    <tr>
        ...
        <th colspan="12"style="vertical-align: middle;text-align: center;" >Final Report (Roster wise)</th>
    </tr>
    <tr>
        <th colspan="12" style="text-align: center;vertical-align: middle;">Date : {{\Carbon\Carbon::parse($startDate)->format('Y-m-d')}} - {{\Carbon\Carbon::parse($endDate)->format('Y-m-d')}}->({{\Carbon\Carbon::parse($RosterInfo->inTime)->format('H:m A')}}-{{\Carbon\Carbon::parse($RosterInfo->outTime)->format('H:m A')}})</th>
    </tr>
    <tr >
